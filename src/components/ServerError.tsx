  ...
  return (
    <div className='text-center text-secondary p-5'>
        <div className='mb-2 justify-content-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-database-fill-x" viewBox="0 0 16 16">
        ...
        The server is not responding. Try reloading the page
    </div>
  )
}
